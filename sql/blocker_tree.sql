...
select lpad( '  ', 2*(level-1) ) || t.waiter lock_tree, t.username, t.sql_id, t.status, t.pq
   from ( select l1.blocker, l1.waiter, l1.waiter_username username, l1.sql_id, l1.status, l1.waiter_pq pq
             from lk l1
          union all
          select distinct NULL, l2.blocker, l2.blocker_username, l2.blocking_sql_id, l2.blocking_status, l2.blocker_pq
             from lk l2
